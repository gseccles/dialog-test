define('app',['exports', 'aurelia-dialog', 'aurelia-framework', './my-modal'], function (exports, _aureliaDialog, _aureliaFramework, _myModal) {
   'use strict';
   ...
   var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaDialog.DialogService), _dec(_class = function () {
      ...
      App.prototype.openModal = function openModal() {
         this.dialogService.open({ viewModel: _myModal.Modal, model: 'Select A Number' }).then(function (response) {
...
define('my-modal-api',["exports"], function (exports) {
  "use strict";
  ...
  var reportHistory = [{
    ...
    "rsids": ["martcom", "getusprod", "mainprod"]
  }, {
    "name": "Finance",
    "rsids": ["bank1", "bank2", "bank3", "bank4"]
  }];

  var ModalAPI = exports.ModalAPI = function () {
    function ModalAPI() {
      _classCallCheck(this, ModalAPI);

      this.isRequesting = false;
    }

    ModalAPI.prototype.getReportHistory = function getReportHistory() {
      var _this = this;

      this.isRequesting = true;
      return new Promise(function (resolve) {
        setTimeout(function () {
          resolve(JSON.parse(JSON.stringify(reportHistory)));
...
define('my-modal',['exports', 'aurelia-framework', 'aurelia-dialog'], function (exports, _aureliaFramework, _aureliaDialog) {
	'use strict';
	...
	var Modal = exports.Modal = (_dec = (0, _aureliaFramework.inject)(_aureliaDialog.DialogController), _dec(_class = function () {
		...
		Modal.prototype.activate = function activate(title) {
			this.title = title;
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><button click.trigger=\"openModal()\">OPEN MODAL</button><template></template></template>"; });
define('text!my-modal.html', ['module'], function(module) { module.exports = "<template><form><ai-dialog class=\"rsid-selector panel panel-primary\"><ai-dialog-header class=\"panel-heading\"><h4 class=\"modal-title\">${title}</h4></ai-dialog-header><ai-dialog-body class=\"panel-body container-fluid\"><div class=\"row\"><div class=\"col-sm-6 form-group\"><label>Report:</label><select value.bind=\"selectedNumber\" class=\"input-md form-control\"><option>1</option><option>2</option><option>3</option><option>4</option></select></div></div></ai-dialog-body><ai-dialog-footer><button click.trigger=\"controller.cancel()\">Cancel</button> <button click.trigger=\"controller.ok(selectedNumber)\">Save</button></ai-dialog-footer></ai-dialog></form></template>"; });
